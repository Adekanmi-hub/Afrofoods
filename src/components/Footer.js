  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <Typography variant="body2" sx={{ color: "#FFFFFF" }}>
            Our purpose is to help our customers reach out to their loved ones
      ...
      >
        ...
        >
          <Box href="https://twitter.com" underline="none" target="_blank">
            <img src={require("../assets/Twitter.png")} alt="twitter" />
          </Box>
          <Box href="/" underline="none" target="_blank">
